...
export const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  PL: {
    ...
    ACHIEVEMENT_FIRST_STEPS_DESC:
      "Zarób łącznie 100 monet ze sprzedaży swoich plonów.",
    ACHIEVEMENT_REWARD_4X4: "Upgrade: Powiększenie ogrodu (4x4).",
    ACHIEVEMENT_GOLDEN_HAND_TITLE: "Złota Rączka",
    ACHIEVEMENT_GOLDEN_HAND_DESC:
      "Zarób łącznie 1 000 monet ze sprzedaży swoich plonów.",
    ACHIEVEMENT_REWARD_5X5: "Upgrade: Powiększenie ogrodu (5x5).",
    ACHIEVEMENT_GREEN_INVESTOR_TITLE: "Zielony Inwestor",
    ACHIEVEMENT_GREEN_INVESTOR_DESC:
      "Zarób łącznie 10 000 monet ze sprzedaży swoich plonów.",
    ACHIEVEMENT_REWARD_SOON: "Wkrótce nowa nagroda!",
    ACHIEVEMENT_FLORA_TYCOON_TITLE: "Magnat Flory",
    ACHIEVEMENT_FLORA_TYCOON_DESC:
      "Zarób łącznie 100 000 monet ze sprzedaży swoich plonów.",
    ...
    ITEM_GRASS_DESC:
      "Dzika trawa, która łatwo się rozprzestrzenia. Świetna do wypełniania przestrzeni.",
    ITEM_GRASS_RULES:
