  ...
  create() {
    ...
    if (this.gameStateManager) {
      this.gameStateManager.on(Events.GOLD_CHANGED, (gold: number) => {
        ...
        this.goldIcon.setX(this.goldText.x + this.goldText.width);
      });
    ...
    slotGraphics.fillRoundedRect(
      this.UI_CENTER_X - 150,
      this.INVENTORY_Y - 60,
      300,
      120,
      20,
    ...
    const tradeBtn = this.add
      .text(this.UI_CENTER_X, this.INVENTORY_Y + 80, "HANDEL", {
        ...STYLES.BUTTON,
    ...
    const resetBtn = this.add
      .text(this.UI_CENTER_X, this.INVENTORY_Y + 160, "RESET", {
        ...STYLES.BUTTON,
        fontSize: "24px",
